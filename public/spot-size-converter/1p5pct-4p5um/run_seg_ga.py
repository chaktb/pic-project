...
bounds = SegGABounds(pitch_um=(3.0,8.0), duty_start=(0.75,0.98), duty_end=(0.10,0.40),
                     w_start=(4.5,4.5), w_end=8.5, n_seg=(35,100),
                     profiles=("linear","quad","cos"))
print('1.5%% 4.5x4.5um: n_clad=%.5f n_core=%.5f'%(plat.n_clad,plat.n_core))
ga = SegSSCGeneticOptimizer(plat, grid, bounds, pop_size=12, n_gen=6, seed=11, leadins=[(50.0,4.5)])
r = ga.run()
g = r['best_gene']
print('=== BEST ===')
...
pickle.dump((g,r),open('best1545.pkl','wb'))
